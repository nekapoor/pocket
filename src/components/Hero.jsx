...
import logoUsaSwimming from '@/images/logos/usa_swimming.svg'
import logoUsaTrackAndField from '@/images/logos/usa_track_and_field.svg'
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-gray-900">
              COVID-19 results you can trust.
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              The BD Veritor COVID-19 test is first test to use your smartphone† to interpret and deliver clear results
            </p>
          ...
          <div className="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
            ...
            >
              {[
                ['USA Track And Field', logoUsaTrackAndField],
                ['USA Swimming', logoUsaSwimming],
              ].map(([name, logo, className]) => (
                <li key={name} className={clsx('flex', className)}>
                  <Image src={logo} alt={name} className="h-20" unoptimized />
                </li>
              ))}
            </ul>
          </div>
